...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(AI_1_GPIO_Port, AI_1_Pin);

    HAL_GPIO_DeInit(AI_2_GPIO_Port, AI_2_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(MAC_IOX_I2C_SCL_GPIO_Port, MAC_IOX_I2C_SCL_Pin);

    HAL_GPIO_DeInit(MAC_IOX_I2C1_SDA_GPIO_Port, MAC_IOX_I2C1_SDA_Pin);
  ...
  /* USER CODE END I2C4_MspDeInit 0 */
    ...
    PD13     ------> I2C4_SDA
    */
    HAL_GPIO_DeInit(IOL_I2C4_SCL_GPIO_Port, IOL_I2C4_SCL_Pin);

    HAL_GPIO_DeInit(IOL_I2C4_SDA_GPIO_Port, IOL_I2C4_SDA_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(IOL4_TX_U4_GPIO_Port, IOL4_TX_U4_Pin);

    HAL_GPIO_DeInit(IOL4_RX_U4_GPIO_Port, IOL4_RX_U4_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB13     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, IOL1_RX_U5_Pin|IOL1_TX_U5_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PF7     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOF, IOL2_RX_U7_Pin|IOL2_TX_U7_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB15     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, IOL3_TX_U1_Pin|IOL3_RX_U1_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, RS485_TX_U2_Pin|RS485_RX_U2_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC10     ------> USART3_TX
    */
    HAL_GPIO_DeInit(DBUG_RX_U3_GPIO_Port, DBUG_RX_U3_Pin);

    HAL_GPIO_DeInit(DBUG_TX_U3_GPIO_Port, DBUG_TX_U3_Pin);
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOC, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_12);
